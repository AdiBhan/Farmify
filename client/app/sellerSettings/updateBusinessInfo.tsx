...
export default function UpdateBusinessInfo() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (
        response.data.message === "Business information updated successfully"
      ) {
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.buttonContainer}>
            <TextInput
              ...
              style={styles.input}
              placeholder="Business Name (e.g., John’s Bakery)"
            ...
            <TextInput
              ...
              style={styles.input}
              placeholder="Full Address (e.g., 123 Main St, City, ZIP)"
              placeholderTextColor="#999"
              value={address}
              editable={!isLoading}
            />
