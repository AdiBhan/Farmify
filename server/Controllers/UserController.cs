...
{
    // Defines the base route for user-related operations
    [Route("api/users/")]
    [ApiController]
    public class UserController : Controller
    {
        ...
        // GET: api/users/oauth/login
        // Initiates OAuth login with Google
        [HttpGet("oauth/login")]
        public IActionResult LoginWithGoogle()
        {
            // Redirects to Google login and specifies the post-login redirect URI
        ...
        // Handles user login, validates credentials, and updates session ID
        ...
        // Handles user registration and creates buyer or seller profiles
        [HttpPost("register")]
